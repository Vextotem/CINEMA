...
const Trailerfunc = function (id) {
  return `<iframe style="display:block; margin:0 auto;" id="iframe-embed" width="100%" height="100%" scrolling="no" frameborder="0" class="youtubePlayer" sandbox="allow-forms allow-pointer-lock allow-same-origin allow-scripts allow-top-navigation" src="https://vidsrc2.to/embed/movie/${id}?sub_url=https%3A%2F%2Fvidsrc.me%2Fsample.srt&ds_langs=en,de" allowfullscreen="true" webkitallowfullscreen="true" referrerpolicy="origin" mozallowfullscreen="true"></iframe>`;
};
  ...
  fetch('https://api.themoviedb.org/3/movie/' + movieId + '?api_key=3754bca4db6bbf31b3d71ca72cdd0f2b&append_to_response=videos')
    ...
    .then(data => {
      ...
      if (trailer) {
        ...
        const movieTitle = data.title; // Get the title of the movie
        document.querySelector('.modal-content h2').innerText = movieTitle; // Set the modal title
      } else {
  ...
  return `<div class="movie_details">
    ...
    <div class="movie_details_about">
        ...
        <div class="date_rating">
            ...
            <span > <a class="GoogleButton" href="https://bracemascara.com/hyj6kuxb6a?key=3a53c6309d6e8e4689d1b52f896bdb55" >Fast Download</a> </span> 
            </div>
